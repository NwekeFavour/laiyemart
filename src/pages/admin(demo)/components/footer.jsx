    ...
    <footer className="bg-gray-900 text-gray-200 py-12">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400 text-sm">
            <li>
              <Link to={getStorePath("/about")} className="hover:text-white">
                About Us
              </Link>
            </li>
            <li>
              <Link to={getStorePath("/contact")} className="hover:text-white">
                Contact
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <div className="flex items-center gap-4 bg-gray-900 p-4 rounded-lg">
            {" "}
            {/* Dark background to test */}
            {/* Visa - Added a white background 'card' style */}
            <div className="bg-white px-2 py-1 rounded flex items-center shadow-sm">
              <img
