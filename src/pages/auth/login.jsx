    ...
    >
      ...
      >
        ...
        {error && (
          <Typography
            level="body-sm"
            className="bg-red-500/20! p-2! rounded-md!"
            sx={{ color: "red", mt: 1, textAlign: "start" }}
          >
            {error}
          </Typography>
        )}
            ...
            >
              ...
              <Typography
                ...
                sx={{
                  color: "#3b82f6",
                  cursor: "pointer",
                  "&:hover": {textDecoration: "underline", textDecorationColor: 'neutral.900',textDecorationStyle: 'solid' },
                }}
              >
                <Link
